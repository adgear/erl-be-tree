...
static ERL_NIF_TERM nif_betree_search_ids_yield(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[])
{
    if(argc != 5) {
        return enif_make_badarg(env);
    }
...
static ErlNifFunc nif_functions[] = {
    ...
    {"betree_search", 2, nif_betree_search, ERL_DIRTY_JOB_CPU_BOUND},
    {"betree_search", 3, nif_betree_search_t, ERL_DIRTY_JOB_CPU_BOUND},
    {"betree_search_evt", 3, nif_betree_search_evt, ERL_DIRTY_JOB_CPU_BOUND},
    {"betree_search_evt", 4, nif_betree_search_evt_ids, ERL_DIRTY_JOB_CPU_BOUND},
    {"betree_search_ids", 4, nif_betree_search_ids, ERL_DIRTY_JOB_CPU_BOUND},
